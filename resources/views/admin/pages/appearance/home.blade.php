                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card card-fluid">
                            ...
                            @include('admin.pages.appearance.menu-bar', ['active' => 'home'])
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <div class="card card-fluid">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        <label class="col-form-label" for="sidebar_script_4">Ads Script</label>
                                                        <textarea class="form-control" id="sidebar_script_4" name="sidebar_script_4" rows="4" placeholder="Ads Script">{{ $option ? $option['sidebar_script_4'] : null }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
