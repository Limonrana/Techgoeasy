                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card card-fluid">
                            ...
                            @include('admin.pages.appearance.menu-bar', ['active' => 'header'])
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <div class="card card-fluid">
                            ...
                            <div class="card-body">
                                <!-- form -->
                                <form method="POST" action="{{ route('admin.customize.update', 'header') }}">
                                    @csrf
                                    @method('put')
                                    <!-- .form-group -->
                                                ...
                                                <figure class="figure">
                                                    ...
                                                    <figcaption class="figure-caption">
                                                        <ul class="list-inline d-flex text-muted mb-0">
                                                            <li id="preview-name" class="list-inline-item text-truncate mr-auto">Header Logo</li>
                                    ...
                                    <div class="list-group list-group-flush mt-3 mb-0">
                                        ...
                                        <div class="list-group-item">
                                            ...
                                            <div class="list-group-item-body">
                                                <input type="text" class="form-control" name="facebook" placeholder="Facebook URL" value="{{ $option ? $option['facebook'] : null }}">
                                            </div>
                                        </div>
                                        <!-- .list-group-item -->
                                        <div class="list-group-item">
                                            ...
                                            <div class="list-group-item-body">
                                                <input type="text" class="form-control" name="twitter" placeholder="Twitter URL" value="{{ $option ? $option['twitter'] : null }}">
                                            </div>
                                        </div>
                                        <!-- .list-group-item -->
                                        <div class="list-group-item">
                                            ...
                                            <div class="list-group-item-body">
                                                <input type="text" class="form-control" name="linkedin" placeholder="Linkedin URL" value="{{ $option ? $option['linkedin'] : null }}">
                                            </div>
                                        </div>
                                        <!-- .list-group-item -->
                                        <div class="list-group-item">
                                            ...
                                            <div class="list-group-item-body">
                                                <input type="text" class="form-control" name="instagram" placeholder="Instagram URL" value="{{ $option ? $option['instagram'] : null }}">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.list-group -->
