...
@section('title', 'Customize Taxonomy')
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card card-fluid">
                            ...
                            @include('admin.pages.appearance.menu-bar', ['active' => 'taxonomy'])
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <div class="card card-fluid">
                            <h6 class="card-header">Taxonomy Page Ads</h6>
                            <!-- form -->
                            <form method="POST" action="{{ route('admin.customize.update', 'taxonomy') }}">
                                @csrf
                                @method('put')
                                <div class="card-body">
                                    <fieldset>
