                        ...
                        <div class="col-lg-9 col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="edit-slug-box" class="d-none mt-2">
                                            ...
                                            <span id="sample-permalink">
                                                <a href="javascript:;">{{ $app_url }}/<span id="editable-post-name">{{ old('slug') }}</span></a>
                            ...
                            <div class="card card-fluid mb-4">
                                ...
                                <div class="card-body text-gray-700">
                                    <div class="form-group">
                                        <label class="col-form-label" for="meta_title">
                                            <span>SEO Title</span>
                            ...
                            <div class="card card-fluid mb-4">
                                ...
                                <div class="card-body text-gray-700">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="click_url_1" name="click_url_1" placeholder="Click URL" value="{{ old('click_url_1') }}" />
                                    </div>
                                    <div class="form-group">
                                        <label class="col-form-label" for="click_url_2">Click URL 2</label>
                                        <input type="text" class="form-control" id="click_url_2" name="click_url_2" placeholder="Click URL" value="{{ old('click_url_2') }}" />
                                    </div>
                                    <div class="form-group">
                                        <label class="col-form-label" for="click_url_3">Click URL 3</label>
                                        <input type="text" class="form-control" id="click_url_3" name="click_url_3" placeholder="Click URL" value="{{ old('click_url_3') }}" />
                                    </div>
                                    <div class="form-group">
                                        <label class="col-form-label" for="click_url_4">Click URL 4</label>
                                        <input type="text" class="form-control" id="click_url_4" name="click_url_4" placeholder="Click URL" value="{{ old('click_url_4') }}" />
                                    </div>
                                </div>
                            </div>
                        </div>
